    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Market</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="market-table" class="table m-t-30 table-hover no-wrap contact-list"
    ...
    <script>
        $(function() {
         ...
         var table = $('#market-table').DataTable({
            ...
            $("#create_market_form").on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 1) {
                            $('#market-table').DataTable().ajax.reload(null, false);
                            $('#create_market_form')[0].reset();
            ...
            $(document).on('click', '#addmarketBtn', function() {
                $('#create_market_form')[0].reset();
                $('#add-market-modal').modal('show');
            });

            $(document).on('click', '#editmarketBtn', function() {
                var id = $(this).data('id');
                $('#update_market_form')[0].reset();
                $(document).find('span.error-text').text('');
                $('#edit-market-modal').modal('show');
                $.get("{{ url('/market/edit/') }}" + '/' + id, function(data) {
            ...
            $("#update_market_form").on('submit', function(e) {
                e.preventDefault();
