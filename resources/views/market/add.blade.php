<tr>
    <div id="add-market-modal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{ route('market.store') }}"
                        id="create_market_form">
                        @csrf
                        <div class="form pt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                   ...
                                   <div id="loadingLga" style="display:none"> <img
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <select id="formGender" name="lga" class="form-control select">
