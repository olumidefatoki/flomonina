<tr>
    <div id="edit-delivery-modal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{ route('delivery-update') }}" id="update_delivery_form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form pt-s">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name="processor_price" placeholder="Processor Price">
                                    <span style="font-size: 10px;" class="text-danger error-text processor_price_error"></span>
