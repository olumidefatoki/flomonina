<tr>
    <div id="edit-partner-modal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{ route('partner-update') }}"
                        id="update_partner_form">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="  col-md-12 m-b-20">
                                <input type="text" class="form-control" name="contact_person_email" value=""
                            ...
                            <div class="col-md-12 m-b-20">
                                <input type="text" class="form-control" name="contact_person_phone_number" value=""
