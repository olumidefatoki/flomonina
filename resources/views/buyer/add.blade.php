<tr>
    <div id="add-buyer-modal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{ route('buyer.store') }}"
                        id="create_buyer_form">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-12 m-b-20">
                                <input type="text" class="form-control" name="contact_person_first_name"
                                    placeholder="Contact Person Email First Name">
                                <span style="font-size: 10px;"
