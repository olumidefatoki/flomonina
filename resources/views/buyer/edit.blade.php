<tr>
    <div id="edit-buyer-modal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="{{ route('buyer-update') }}"
                        id="update_buyer_form">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-12 m-b-20">
                                <input type="text" class="form-control" name="contact_person_first_name" 
                                    placeholder="Contact Person Email First Name"  value="">
                                <span style="font-size: 10px;"
                                    class="text-danger error-text contact_person_first_name_error"></span>
                            </div>

                            <div class="col-md-12 m-b-20">
                                <input type="text" class="form-control" name="contact_person_last_name"
                                    value=""" placeholder="Contact Person Last Name">
                            </div>
                            <div class="  col-md-12 m-b-20">
                                <input type="text" class="form-control" name="contact_person_email" 
                                placeholder="Contact Person Email" value="">
                                <span style="font-size: 10px;"
                            ...
                            <div class="col-md-12 m-b-20">
                                ...
                                placeholder="Contact Person Phone Number" value="">
                                <span style="font-size: 10px;"
