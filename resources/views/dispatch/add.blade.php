                        ...
                        <div class="form pt-s">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    ...
                                    <span style="font-size: 12px;"
                                        class="text-danger error-text pickup_state_error "></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    ...
                                    <span style="font-size: 12px;"
                                        class="text-danger error-text destination_state_error "></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name="logistics_company"
                                        placeholder="logistics_company">
                                    <span style="font-size: 12px;"
                                        class="text-danger error-text logistics_company_error"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    ...
                                    <span style="font-size: 12px;"
                                        class="text-danger error-text driver_name_error"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    ...
                                    <span style="font-size: 12px;"
                                        class="text-danger error-text driver_phone_number_error"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-5 col-form-label">Expected Arrival Time</label>
                                <div class="col-7">
                                    <input type="text" name="estimated_arrival_time" class="form-control"
                                        placeholder="Estimated Arrival Time" id="eta_date">
                                    <span style="font-size: 12px;"
                                        class="text-danger error-text estimated_arrival_time_error"></span>
                                </div>
                            </div>
